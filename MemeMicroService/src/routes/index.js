...
const route = Router();
const { upload, updatePreference, categoryDeciderHelper, getTrendingMemes, uploadFile } = require('../controller');
...
route.post("/upload2", updatePreference); //Just for testing purpose
